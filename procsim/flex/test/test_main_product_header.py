...
from procsim.flex.main_product_header import (MainProductHeader, opt, eop,
                                              om, ows, xlink)
...
def assertMPHMatchesProduct(product_folder_path: Union[str, Path]) -> None:
    ...
    product_information = xml.getroot().findall(om + 'result/' + eop + 'EarthObservationResult/' + eop + 'product/' + opt + 'ProductInformation')
    ...
    for product_info in product_information[1:]:
        ...
        representation_element = product_info.find(opt + 'rds')
...
def get_l0_test_mph():
    ...
    mph.products = [
        ...
        {'file_name': './flx_l0__obs____20170101t060301_20170101t060601_20230112t140940_0180_012_046_0180_1b01_lres.dat', 'size': 0},
        {'file_name': './flx_l0__obs____20170101t060301_20170101t060601_20230112t140940_0180_012_046_0180_1b01_hre1.dat', 'size': 0},
        {'file_name': './flx_l0__obs____20170101t060301_20170101t060601_20230112t140940_0180_012_046_0180_1b01_hre2.dat', 'size': 0},
    ]
    ...
    return 'flx_l0__obs____20170101t060301_20170101t060601_20230112t140940_0180_012_046_0180_1b01.xml', mph
